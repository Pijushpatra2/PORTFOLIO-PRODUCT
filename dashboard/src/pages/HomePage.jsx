...
import AddProject from "./sub_components/AddProject.jsx";
import AddSkill from "./sub_components/AddSkill.jsx";
import AddSoftwareApplications from "./sub_components/AddSoftwareApplications.jsx";
import AddTimeline from "./sub_components/AddTimeline.jsx";
import Messages from "./sub_components/Messages.jsx";
import Account from "./sub_components/Account.jsx";
...
const HomePage = () => {
  ...
  // Effect to dispatch getUser and check user state
  useEffect(() => {
    // console.log("Checking user state inside useEffect:", user); // Log initial user value
    ...
    if (!isAuthenticated) {
      ...
      // console.log("User is already loaded:", user); // Log user if already available
    }
  }, [isAuthenticated, error, dispatch, navigate, user]);
      ...
      <div className="flex min-h-screen w-full flex-col bg-muted/40">
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 max-[900px]:h-[100px]">
          ...
          <div className="flex items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5">
            <img
              src={user && user.avater && user.avater.url}
              alt="avatar"
