...
import SpecialLoadingButton from "./SpecialLoadingBtn";
...
const Messages = () => {
  ...
  // console.log("Current messages state:", { messages, loading, error, message });
  ...
  useEffect(() => {
    console.log("State updated:", { messages, loading, error, message });
  }, [messages, loading, error, message]);
