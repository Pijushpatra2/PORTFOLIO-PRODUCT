...
import SpecialLoadingButton from "./SpecialLoadingBtn.jsx";
...
const UpdateProfile = () => {
  ...
  const [avater, setAvater] = useState(user && user.avater && user.avater.url);
  const [avaterPreview, setAvaterPreview] = useState(
    user && user.avater && user.avater.url
  );
            ...
            <div className="grid gap-4">
              <div className="flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5">
                <div className="grid gap-2 w-full sm:w-72">
                  ...
                  <img
                    src={avaterPreview ? avaterPreview : "/avaterHolder.jpg"}
                    alt="avater"
                ...
                <div className="grid gap-2 w-full sm:w-72">
                  ...
                  >
                    <img
                      src={resumePreview ? resumePreview : "/avaterHolder.jpg"}
                      alt="avater"
                      className="w-full  h-auto sm:w-72 sm:h-72 rounded-2xl"
                    />
                  </Link>
